<div class="border-t">
  <footer class="mt-12 pb-8 px-4 lg:px-0 max-w-7xl mx-auto flex items-center ">
    <div class="flex flex-wrap">
      <div class="w-full lg:w-2/5">
        <div> 
          <!--Logo-->
          <a href="#" class="px-2 lg:px-0 uppercase font-bold text-purple-400">My Blog</a>
        </div>

        <p class="text-gray-600 lg:block mt-4 p-0 lg:pr-12">
